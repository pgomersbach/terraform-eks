...
#### install terraform
curl -s  https://releases.hashicorp.com/terraform/0.11.10/terraform_0.11.10_linux_amd64.zip && unzip terraform_0.11.10_linux_amd64.zip && mv terraform /usr/local/bin && rm -y terraform_0.11.10_linux_amd64.zip
